...
my_metrics <- function(df, pred, labs, tau = 0.5) {
  
  # Ensure numeric 0/1
  labs <- as.numeric(as.character(labs))
...
(val_list, model, target_col, tau = tau)

evaluate_on_validations(val_data_sets,logmod_l1,"fully_booked_30",tau = tau )
